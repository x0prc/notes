...
## Port IO
- 2^16 8-bit IO ports, numbered 0-0xFFFF.
- Can combine 2 or 4 consecutive ports to achieve 16 or 32 bit port.
- 2 bit IOPL (I/O Privilege Level) field in RFLAGS.
	- IN - Input from Port
	- OUT - Output to Port
## CMOS
- Real-time clock.
- 14 bytes of date info + config registers.
- SRM = CMOS transistor based RAM.